...
// Tree has 8 spokes per ring, even and odd rings are
// 22.5 degrees apart.
// Each branch has 72 leds. Starting on the outside,
// 0 to 35 going from the trunk, and on the inside,
// 36 to 71 going from the branch tip.
